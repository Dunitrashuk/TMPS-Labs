...
The builder will contain all of the fields that exist on the Vehicle class itself.We will configure all of the fields that we want on the builder, and then we'll use the builder to create vehicles.
...
```
As we can see the objects we created via builder have the correct fields and are immutable.
```
Type: car
Seats: 5
Wheels: 4
